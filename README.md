...
- Hover over blue comment markers to see the comment tooltip
- Comments display the author's name and timestamp
- **Edit a comment**: Click on a comment marker to edit its text
- **Delete a comment**: Click the trash icon in the comment tooltip
